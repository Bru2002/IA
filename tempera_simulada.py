...
def tempera_simulada():
    ...
    while conflitos_atual != 0 and temperatura > 0.1:
        ...
        if conflitos_novo < conflitos_atual or random.uniform(0, 1) < math.exp((conflitos_atual - conflitos_novo) / temperatura):
        ...
        if conflitos_atual == 0:  # Limite interno para evitar loops infinitos
            break
